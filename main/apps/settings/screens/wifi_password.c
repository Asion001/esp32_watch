...
lv_obj_t *wifi_password_create(lv_obj_t *parent, const char *ssid,
                               bool is_open) {
  ...
  if (!is_open) {
    ...
    lv_obj_add_event_cb(show_hide_btn, show_hide_button_event_cb,
  ...
  lv_obj_add_event_cb(cancel_btn, cancel_button_event_cb, LV_EVENT_CLICKED,
                      NULL);
  ...
  lv_obj_add_event_cb(connect_btn, connect_button_event_cb, LV_EVENT_CLICKED,
                      NULL);
