...
void screen_nav_load_with_anim(lv_obj_t *new_screen, lv_obj_t **prev_screen)
{
    ...
    lv_scr_load_anim(new_screen, LV_SCR_LOAD_ANIM_MOVE_BOTTOM, SCREEN_ANIM_DURATION, 0, false);
}
...
void screen_nav_load_horizontal(lv_obj_t *new_screen, lv_obj_t **prev_screen)
{
    ...
    lv_scr_load_anim(new_screen, LV_SCR_LOAD_ANIM_MOVE_LEFT, SCREEN_ANIM_DURATION, 0, false);
}
...
void screen_nav_go_back_with_anim(lv_obj_t *current_screen, lv_obj_t *prev_screen)
{
    ...
    lv_scr_load_anim(prev_screen, LV_SCR_LOAD_ANIM_MOVE_TOP, SCREEN_ANIM_DURATION, 0, false);
}
...
void screen_nav_go_back_horizontal(lv_obj_t *current_screen, lv_obj_t *prev_screen)
{
    ...
    lv_scr_load_anim(prev_screen, LV_SCR_LOAD_ANIM_MOVE_RIGHT, SCREEN_ANIM_DURATION, 0, false);
}
