...
#define BACKLIGHT_TIMEOUT_MS \
  (CONFIG_SLEEP_MANAGER_BACKLIGHT_TIMEOUT_SECONDS * 1000)
...
static inline bool sleep_manager_should_turn_off_backlight(void) { return false; }
